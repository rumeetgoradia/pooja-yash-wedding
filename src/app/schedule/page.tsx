...
// Import the data and types from the file we created in Step 1
...
function EventDetail({
  ...
  return (
    <div className="flex flex-col gap-2 text-center lg:text-left">
      ...
      <p className="text-lg font-light text-gray-700">{time}</p>
      <div className="mt-2 text-base leading-relaxed text-gray-600">
        {description}
      </div>
      <div className="mt-1 text-sm leading-relaxed text-gray-500 italic">
        {dressCode}
      </div>
      {!isLastEvent && (
  ...
  return (
    <div
      className={cn(
        ...
        isReversed ? "lg:flex-row-reverse" : "lg:flex-row", // Handles the order on large screens
      )}
    >
      {/* Text Content Column */}
      <div
